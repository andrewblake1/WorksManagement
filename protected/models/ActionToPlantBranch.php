...
/**
 * This is the model class for table "tbl_action_to_plant_branch".
 *
 * The followings are the available columns in table 'tbl_action_to_plant_branch':
 * @property integer $id
...
class ActionToPlantBranch extends ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'action' => array(self::BELONGS_TO, 'ActionToPlant', 'action_id'),
