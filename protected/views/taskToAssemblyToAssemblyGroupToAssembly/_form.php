...
$form=$this->beginWidget('WMTbActiveForm', array('model'=>$model));		
	...
	$quantity_tootip = $assemblyToAssemblyGroup->quantity_tootip;
	...
	AssemblyController::listWidgetRow($model, $form, 'assembly_id', array('data-original-title'=>$assemblyToAssemblyGroup->selection_tootip), array('scopeAssemblyGroup'=>array($model->assembly_group_id)));

	$form->textFieldRow('quantity', array('data-original-title'=>$assemblyToAssemblyGroup->quantity_tootip));
