...
$form=$this->beginWidget('WMTbActiveForm', array('model'=>$model));		
	...
	$form->rangeFieldRow('quantity', $taskTemplateToMaterialGroup->minimum, $taskTemplateToMaterialGroup->maximum, $taskTemplateToMaterialGroup->select, $taskTemplateToMaterialGroup->quantity_tooltip);
