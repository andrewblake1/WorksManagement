...
array(
			...
			'type' => 'raw',
			'value' => $model->resourceCategory !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->resourceCategory)), array('resourcecategory/view', 'id' => GxActiveRecord::extractPkValue($model->resourceCategory, true))) : null,
			),
'maximum',
'deleted:boolean',
	),
