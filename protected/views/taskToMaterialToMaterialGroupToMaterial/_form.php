...
$form=$this->beginWidget('WMTbActiveForm', array('model'=>$model));		
	...
	$form->rangeFieldRow('quantity', $assemblyToMaterialGroup->minimum, $assemblyToMaterialGroup->maximimum, $assemblyToMaterialGroup->select, $assemblyToMaterialGroup->quantity_tooltip, $assemblyToMaterialGroup->selection_tooltip);
