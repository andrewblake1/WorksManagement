...
<div id="<?php echo Resourcecategory::ADMIN_TREE_CONTAINER_ID;?>" >
...
"update" : {
	...
	"action" : function (obj) {
                             ...
                             $.ajax({
                                   type:"POST",
			           url:"<?php echo $baseUrl;?>/resourcecategory/returnView",
		                   data:   {
                                             "id" :id,
                                            "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
...
"remove" : {
		       ...
		       $('<div title="Delete Confirmation">\n\
                    ...
                    Resourcecategory <span style="color:#FF73B4;font-weight:bold;">'+(obj).attr('rel')+'</span> and all it\'s subcategories will be deleted.Are you sure?</div>')
                       .dialog({
			resizable: false,
			height:170,
			modal: true,
