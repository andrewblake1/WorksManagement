...
$this->menu=array(
	...
	array('label'=>Yii::t('app', 'Delete') . ' ' . $model->label(), 'url'=>'#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->name), 'confirm'=>'Are you sure you want to delete this item?')),
...
?><h2><?php echo GxHtml::encode($model->getRelationLabel('authItemchildren')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->authItemchildren as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('authItemChild/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ul');
?><h2><?php echo GxHtml::encode($model->getRelationLabel('authItemchildren1')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->authItemchildren1 as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('authItemChild/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
