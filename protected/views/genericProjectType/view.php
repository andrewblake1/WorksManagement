...
array(
			'name' => 'genericProjectCategory',
			'type' => 'raw',
			'value' => $model->genericProjectCategory !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->genericProjectCategory)), array('genericprojectcategory/view', 'id' => GxActiveRecord::extractPkValue($model->genericProjectCategory, true))) : null,
			),
'deleted:boolean',
array(
			'name' => 'staff',
