...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'generic_project_category_id'); ?>
		<?php echo $form->dropDownList($model, 'generic_project_category_id', GxHtml::listDataEx(Genericprojectcategory::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
