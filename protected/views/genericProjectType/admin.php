...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('generic-project-type-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
				'name'=>'generic_project_category_id',
				'value'=>'GxHtml::valueEx($data->genericProjectCategory)',
				'filter'=>GxHtml::listDataEx(Genericprojectcategory::model()->findAllAttributes(null, true)),
				),
		array(
					'name' => 'deleted',
