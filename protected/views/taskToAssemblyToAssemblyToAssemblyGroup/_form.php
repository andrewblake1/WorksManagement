...
$form=$this->beginWidget('WMTbActiveForm', array('model'=>$model));		
	...
	$form->rangeFieldRow('quantity', $assemblyToAssemblyGroup->minimum, $assemblyToAssemblyGroup->maximum, $assemblyToAssemblyGroup->select, $assemblyToAssemblyGroup->quantity_tooltip);
