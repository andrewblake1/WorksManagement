...
array(
			'name' => 'inCharge',
			'type' => 'raw',
			'value' => $model->inCharge !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->inCharge)), array('staff/view', 'id' => GxActiveRecord::extractPkValue($model->inCharge, true))) : null,
			),
array(
			'name' => 'staff',
			'type' => 'raw',
