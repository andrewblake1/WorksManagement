...
array(
			'name' => 'supplier',
			'type' => 'raw',
			'value' => $model->supplier !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->supplier)), array('supplier/view', 'id' => GxActiveRecord::extractPkValue($model->supplier, true))) : null,
			),
'purchase_order_no',
array(
			'name' => 'staff',
