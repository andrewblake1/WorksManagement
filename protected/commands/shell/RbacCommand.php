...
EOD;
	...
	public function run($args)
	{
	    ...
	    if(!strncasecmp(trim(fgets(STDIN)),'y',1)) 
		{
			 ...
			 $task=$this->_authManager->createTask('ProjectToAuthAssignmentToTaskTypeToDutyType', 'ProjectToAuthAssignmentToTaskTypeToDutyType task');
			 $projectManagerRole->addChild('ProjectToAuthAssignmentToTaskTypeToDutyType');
			 $this->_authManager->createOperation('ProjectToAuthAssignmentToTaskTypeToDutyTypeRead', 'ProjectToAuthAssignmentToTaskTypeToDutyType read');
			 $task->addChild('ProjectToAuthAssignmentToTaskTypeToDutyTypeRead');
