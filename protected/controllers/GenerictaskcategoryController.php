...
class GenerictaskcategoryController extends Controller
{
	//UTILITY FUNCTIONS
	...
	*/
	...
	//create an array open_nodes with the ids of the nodes that we want to be initially open
		...
		$categories= Generictaskcategory::model()->findAll(array('order'=>'lft'));
		$identifiers=array();
	...
	{
		Generictaskcategory::printULTree();
	}
...
// Todo: override updateRedirect and createRedirect to ajax refresh of the the tree
	...
	public function actionMoveCopy()
	{
		...
		if ($new_parent_root_id!='root')
		{
			...
			{
				//create the copied Generictaskcategory model
				$copied_node=new Generictaskcategory;
