...
class GenericprojectcategoryController extends Controller
{
	//UTILITY FUNCTIONS
	...
	*/
	...
	{
		Genericprojectcategory::printULTree();
	}
...
// Todo: override updateRedirect and createRedirect to ajax refresh of the the tree
	...
	public function actionMoveCopy()
	{
		...
		if ($new_parent_root_id!='root')
		{
			...
			{
				//create the copied Genericprojectcategory model
				$copied_node=new Genericprojectcategory;
