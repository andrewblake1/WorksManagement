...
class GenericTaskTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['GenericTaskType'];
			if($model->save())
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['GenericTaskType']))
			$model->attributes=$_GET['GenericTaskType'];
	...
	{
		$model=GenericTaskType::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='generic-task-type-form')
		{
